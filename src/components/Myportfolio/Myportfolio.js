...
import workingboy from "../../img/workind-boy.png";
...
import profile1 from "../../img/project1.png";
import profile2 from "../../img/project2.png";
...
import sabari from "../../img/sabari3.png";
import webdevelopment from "../../img/web.jpg";
          ...
          <div className="col-md-12">
            <div id="body">
              ...
              <div id="all-icons">
                <a
                  id="linkedin-icon"
                  href="https://www.linkedin.com/in/sabarinathan-y-b528a21b1"
                >
                  <FaLinkedin />
                </a>
                <a
                  id="git-hub"
                  href="https://github.com/Sabarinathany"
                >
                  <FaGithub />
                </a>
              </div>
            ...
            <div id="div-1">
              ...
              <div id="project-icon-1">
                <p id="project-icon-git">
                  <a href="https://github.com/Sabarinathany/Online-footwear-shop-project" className="a1">
          ...
          <div id="Car-rent">
            ...
            <div id="project-2-b">
              <p id="project2-icon-git">
                <a href="https://github.com/Sabarinathany/Car-Rental-and-Service-project" className="b1">
